...
_DNDEF("FILE_IO")
#endif
#ifdef FILE_IO_MAX_FILES
_DINT1(FILE_IO_MAX_FILES)
#else
_DNDEF("FILE_IO_MAX_FILES")
#endif
#ifdef FILE_SUBDIR
_DSTR1(FILE_SUBDIR)
#else
_DNDEF("FILE_SUBDIR")
#endif
#ifdef FILE_IO_BUFFER_LENGTH
_DINT1(FILE_IO_BUFFER_LENGTH)
#else
_DNDEF("FILE_IO_BUFFER_LENGTH")
#endif
#ifdef FILE_IO_LOGGER
_DDEF("FILE_IO_LOGGER")
#else
_DNDEF("FILE_IO_LOGGER")
#endif
#ifdef FILE_IO_LOGGER_SUBDIR
_DSTR1(FILE_IO_LOGGER_SUBDIR)
#else
_DNDEF("FILE_IO_LOGGER_SUBDIR")
#endif
#ifdef FILE_IO_LOGGER_UMASK
_DDEF("FILE_IO_LOGGER_UMASK")
#else
_DNDEF("FILE_IO_LOGGER_UMASK")
#endif
#ifdef FILE_IO_LOGGER_FORMAT
_DSTR1(FILE_IO_LOGGER_FORMAT)
#else
_DNDEF("FILE_IO_LOGGER_FORMAT")
#endif
#ifdef FILE_IO_LOGGER_FORMAT_VARS
_DSTR1s(FILE_IO_LOGGER_FORMAT_VARS)
#else
_DNDEF("FILE_IO_LOGGER_FORMAT_VARS")
#endif
#ifdef FILE_IO_LOGGER_FORMAT_TIME
_DSTR1(FILE_IO_LOGGER_FORMAT_TIME)
#else
_DNDEF("FILE_IO_LOGGER_FORMAT_TIME")
#endif
